  ...
  return (
    <div className="flex flex-col items-center text-center">
      <div className="relative">
        ...
        <div className="absolute -top-2 -right-2 w-8 h-8 bg-white rounded-full border-2 border-primary flex items-center justify-center text-primary font-bold">
          {number}
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <Step
            ...
            description="Browse through our wide range of services and choose what you need."
            icon={
              <svg
          ...
          <Step
            ...
            description="Our verified professional will arrive at your location on time."
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-8 w-8"
          ...
          <Step
            number={4}
            title="Pay Securely"
            description="Rate the service and make a secure payment only when satisfied."
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-8 w-8"
